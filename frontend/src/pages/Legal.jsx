...
export default function Legals({ activeModal, onClose }) {
      ...
      {activeModal && (
        <div className="overlay">
          <div className="Legals">
            <div className="legals-content">
              ...
              <p>
                ...
                <p>
                  ...
                  capable au sens des articles 1123 et suivants du Code civil,
                  ou personne morale, qui visite le Site objet des présentes
                ...
                <p>
                  <b>Utilisateur :</b> Internaute se connectant, utilisant le
                  site susnommé.
                </p>
                <p>
                ...
                <p>
                  ...
                  concernée », « sous traitant » et « données sensibles » ont le
                ...
                <p>
                  <strong>Propriétaire</strong> : EIRL Creapose Capital social
                  de 3000€ Numéro de TVA: FR74531157212 – 1 allée d’Effiat 91160
                  Longjumeau
                  <br />
                  <strong>Responsable publication</strong> : Peruzzo – 09 81 04
                  76 85
                  <br />
                  Le responsable publication est une personne physique ou une
                  personne morale.
                  <br />
                  <strong>Webmaster</strong> : Creapose – contact@creapose.fr
                  <br />
                  <strong>Hébergeur</strong> : OVH – 2 rue Kellermann 59100
                  Roubaix +33 9 72 10 10 07
                  <br />
                  <strong>Délégué à la protection des données</strong> : Peruzzo
                  – contact@creapose.fr
                  <br />
                </p>
                <p>
                ...
                <p>
                  ...
                  Réglementations Internationales applicables. Le Client ne peut
                ...
                <p>
                  ...
                  <a href="http://harmonisons.com/">
                    http://harmonisons.com/
                  </a>{" "}
                  s’efforce de fournir sur le site{" "}
                  <a href="http://harmonisons.com/">http://harmonisons.com/</a>{" "}
                  des informations aussi précises que possible. Toutefois, il ne
                  pourra être tenu responsable des oublis, des inexactitudes et
                ...
                <p>
                  ...
                  Européenne conformément aux dispositions du Règlement Général
                ...
                <p>
                  ...
                  l’année. Il se réserve néanmoins la possibilité d’interrompre
                  le service d’hébergement pour les durées les plus courtes
                  possibles notamment à des fins de maintenance, d’amélioration
                  de ses infrastructures, de défaillance de ses infrastructures
                ...
                <p>
                  ...
                  dysfonctionnement du réseau Internet, des lignes téléphoniques
                ...
                <p>
                  ...
                  en cas de message à caractère raciste, injurieux, diffamant,
                ...
                <p>
                  ...
                  Liberté du 06 Août 2004 ainsi que du Règlement Général sur la
                ...
                <p>
                  ...
                  Données Personnelles est : Creapose.{" "}
                  <a href="http://harmonisons.com/">http://harmonisons.com/</a>
                  est représenté par Peruzzo, son représentant légal
                </p>
                <p>
                ...
                <p>
                  ...
                  uniquement utilisées par nécessité ou à des fins statistiques
                  et d’analyses.
                </p>
                ...
                <ul>
                  <li>
                    ...
                    Utilisateurs droit de verrouillage ou d’effacement des
                    données des Utilisateurs à caractère personnel (article 17
                    du RGPD), lorsqu’elles sont inexactes, incomplètes,
                  ...
                  <li>
                    ...
                    traitements automatisés fondés sur leur consentement ou sur
                    un contrat (article 20 RGPD){" "}
                  </li>

                  <li>
                    droit de définir le sort des données des Utilisateurs après
                    leur mort et de choisir à qui{" "}
                    <a href="http://harmonisons.com/">
                      http://harmonisons.com/
                    </a>{" "}
                ...
                Creapose – DPO, Peruzzo <br />1 allée d’Effiat 91160 Longjumeau.
                <p>
                ...
                <p>
                  ...
                  préserver la sécurité des Informations et notamment qu’elles
                  ...
                  lui communiquer les mesures de corrections prises. Par
                  ailleurs{" "}
                  <a href="http://harmonisons.com/">http://harmonisons.com/</a>{" "}
                ...
                <p>
                  ...
                  toutes les questions relevant de la sécurité de leur compte et
                  à leur fournir toutes les informations nécessaires pour les
                  aider à respecter leurs propres obligations réglementaires en
                ...
                <p>
                  ...
                  informations à l'éventuel acquéreur qui serait à son tour tenu
                  de la même obligation de conservation et de modification des
                ...
                <p>
                  ...
                  contre toute perte, utilisation détournée, accès non autorisé,
                ...
                <p>
                  ...
                  visités, et n’assumera en conséquence aucune responsabilité de
                  ce fait.
                </p>
                ...
                <p>
                  ...
                  navigateur de l’Utilisateur et enregistré au sein du terminal
                  de l’Utilisateur (ex : ordinateur, smartphone), (ci-après «
                  Cookies »). Ce fichier comprend des informations telles que le
                  nom de domaine de l’Utilisateur, le fournisseur d’accès
                  Internet de l’Utilisateur, le système d’exploitation de
                  l’Utilisateur, ainsi que la date et l’heure d’accès. Les
                  Cookies ne risquent en aucun cas d’endommager le terminal de
                  l’Utilisateur.
                </p>
                <p>
                  <a href="http://harmonisons.com/">http://harmonisons.com/</a>{" "}
                  est susceptible de traiter les informations de l’Utilisateur
                  concernant sa visite du Site, telles que les pages consultées,
                  les recherches effectuées. Ces informations permettent à{" "}
                  <a href="http://harmonisons.com/">http://harmonisons.com/</a>{" "}
                ...
                <p>
                  ...
                  émetteur. L’Utilisateur peut également configurer son logiciel
                  de navigation de manière à ce que l’acceptation ou le refus
                  des Cookies lui soient proposés ponctuellement, avant qu’un
                ...
                <p>
                  ...
                  terminal ou son navigateur, ou si l’Utilisateur supprime ceux
                  qui y sont enregistrés, l’Utilisateur est informé que sa
                  navigation et son expérience sur le Site peuvent être
                  limitées. Cela pourrait également être le cas lorsque{" "}
                  <a href="http://harmonisons.com/">http://harmonisons.com/</a>{" "}
                  ou l’un de ses prestataires ne peut pas reconnaître, à des
                  fins de compatibilité technique, le type de navigateur utilisé
                  par le terminal, les paramètres de langue et d’affichage ou le
                  pays depuis lequel le terminal semble connecté à Internet.
                </p>
                <p>
                  Le cas échéant,{" "}
                  <a href="http://harmonisons.com/">http://harmonisons.com/</a>{" "}
                ...
                <p>
                  À tout moment, l’Utilisateur peut faire le choix d’exprimer et
                  de modifier ses souhaits en matière de Cookies.{" "}
                  <a href="http://harmonisons.com/">http://harmonisons.com/</a>{" "}
                  pourra en outre faire appel aux services de prestataires
                  externes pour l’aider à recueillir et traiter les informations
                  décrites dans cette section.
                </p>
                <p>
                  Enfin, en cliquant sur les icônes dédiées aux réseaux sociaux
                  Twitter, Facebook, Linkedin et Google Plus figurant sur le
                  Site de{" "}
                  <a href="http://harmonisons.com/">http://harmonisons.com/</a>{" "}
                ...
                <p>
                  ...
                  l’efficacité de ses actions (par exemple, le nombre de fois où
                  une page est ouverte et les informations consultées), ainsi
            ...
            <button onClick={handleCloseModal} className="modalButton">
              <GrClose />
            </button>
          </div>
        </div>
